...
void test_yaml() {
    //把yaml加载进来，以node的方式
    YAML::Node root = YAML::LoadFile("/home/leven/sylar/workspace/bin/conf/test.yml");
    print_yaml(root, 0);
...
//     YAML::Node root = YAML::LoadFile("/home/leven/sylar/workspace/bin/conf/log.yml");
//     sylar::Config::LoadFormYaml(root);
//     std::cout << "=====================" << std::endl;
//     std::cout << sylar::LoggerMgr::GetInstance()->toYamlString() << std::endl;
//     std::cout<<"--------------"<<std::endl;
//     std::cout<<root<<std::endl;
//     SYLAR_LOG_INFO(system_log) << "hhello system" << std::endl;

//     system_log->setFormatter("%d - %m%n");
//     SYLAR_LOG_INFO(system_log) << "hhhello system" << std::endl;
// }

void test_loadconf() {
    sylar::Config::LoadFormConfDir("conf");
}
